...
func request_Chat_LineWebhook_0(ctx context.Context, marshaler runtime.Marshaler, client ChatClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq WebhookMessageInput
	...
	msg, err := client.LineWebhook(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
...
func RegisterChatHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ChatClient) error {
	...
	mux.Handle("POST", pattern_Chat_LineWebhook_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Chat_LineWebhook_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_Chat_LineWebhook_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_Chat_LineWebhook_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"line", "otp", "reset-pin-scope"}, "", runtime.AssumeColonVerbOpt(true)))
)

var (
	forward_Chat_LineWebhook_0 = runtime.ForwardResponseMessage
)
